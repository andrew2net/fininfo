...
//	public $layout='//layouts/column2';
	...
	public function registerScript() {
		$basePath=Yii::getPathOfAlias('application.modules.admin.modules.user.views.asset');
	...
	public static function getWidgets($fieldType='') {
		$basePath=Yii::getPathOfAlias('application.modules.admin.modules.user.components');
		$widgets = array();
