...
class Profile extends UActiveRecord
{
	...
	{
		return Yii::app()->getModule('admin')->getModule('user')->tableProfiles;
	}
	...
	public function attributeLabels()
	{
		...
		foreach ($model as $field)
			$labels[$field->varname] = ((Yii::app()->getModule('admin')->getModule('user')->fieldsMessage)?UserModule::t($field->title,array(),Yii::app()->getModule('user')->fieldsMessage):UserModule::t($field->title));
