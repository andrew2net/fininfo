...
class UserModule extends CWebModule {
  ...
  public function init() {
    ...
    $this->setImport(array(
      ...
      'application.modules.admin.modules.user.components.*',
    ));
  }
  ...
  public static function encrypting($string = "") {
    $hash = Yii::app()->getModule('admin')->getModule('user')->hash;
    if ($hash == "md5")
      return md5($string);
    if ($hash == "sha1")
      return sha1($string);
  ...
  public static function doCaptcha($place = '') {
    ...
    if (in_array($place, Yii::app()->getModule('user')->captcha))
      return Yii::app()->getModule('admin')->getModule('user')->captcha[$place];
    return false;
  }
